...
def customized_lmp_template_task_group_args():
    ...
    return [
        ...
        Argument("input_extra_files", list, optional=True, default=[], doc=doc_input_extra_files),
        Argument("output_dir_pattern", [str,list], optional=True, default="*", doc=doc_output_dir_pattern),
        Argument("output_lmp_conf_name", str, optional=True, default=lmp_conf_name, doc=doc_output_lmp_conf_name),
        Argument("output_lmp_tmpl_name", str, optional=True, default=lmp_input_name, doc=doc_output_lmp_tmpl_name),
        Argument("output_plm_tmpl_name", str, optional=True, default=plm_input_name, doc=doc_output_plm_tmpl_name),
    ]
