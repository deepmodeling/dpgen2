...
class CustomizedLmpTemplateTaskGroup(ConfSamplingTaskGroup):
  ...
  def set_lmp(
    ...
    custom_shell_commands: str
        ...
        and `custom_extra_files` as extra input files.
    ...
    tmp_custom_extra_files = [Path(ii) for ii in custom_extra_files]
    tmp_custom_extra_files.append(self.lmp_template_fn)
    if self.has_plm:
      tmp_custom_extra_files.append(self.plm_template_fn)
    if custom_shell_commands is not None:
      self.custom_extra_files = [ii.name for ii in tmp_custom_extra_files]
      self.custom_extra_file_contents = [Path(ii).read_text() for ii in tmp_custom_extra_files]
