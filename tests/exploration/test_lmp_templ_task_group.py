...
expected_lmp_template = textwrap.dedent("""variable        NSTEPS          equal V_NSTEPS
variable        THERMO_FREQ     equal 10
variable        DUMP_FREQ       equal 10
variable        TEMP            equal V_TEMP
variable        PRES            equal 0.0
...
in_lmp_plm_template = textwrap.dedent("""variable        NSTEPS          equal V_NSTEPS
variable        THERMO_FREQ     equal 10
variable        DUMP_FREQ       equal 10
variable        TEMP            equal V_TEMP
variable        PRES            equal 0.0
...
expected_lmp_plm_template = textwrap.dedent("""variable        NSTEPS          equal V_NSTEPS
variable        THERMO_FREQ     equal 10
variable        DUMP_FREQ       equal 10
variable        TEMP            equal V_TEMP
variable        PRES            equal 0.0
...
in_plm_template = textwrap.dedent("""FOO V_TEMP
...
class TestLmpTemplateTaskGroup(unittest.TestCase):
    ...
    def test_lmp(self):        
        ...
        self.assertEqual(
            ngroup, 
            len(self.confs) * len(self.lmp_rev_mat['V_NSTEPS']) \
